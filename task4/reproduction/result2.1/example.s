...
define i32 @main(i32 %0, i8** nocapture readnone %1) local_unnamed_addr #0 {
  ...
  %4 = tail call i8* @__runtime_checkbound(i8* %3) #4
  %5 = bitcast i8* %4 to i32*
  %6 = load i32, i32* %5, align 4, !tbaa !3
  %7 = tail call i32 (i32, i8*, ...) @__printf_chk(i32 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %6) #4
  %8 = tail call i8* @__runtime_checkbound(i8* %3) #4
  %9 = bitcast i8* %8 to i32*
  %10 = load i32, i32* %9, align 4, !tbaa !3
  %11 = tail call i32 (i32, i8*, ...) @__printf_chk(i32 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %10) #4
